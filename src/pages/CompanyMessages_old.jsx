...
const CompanyMessages = () => {
      ...
      const mockMessages = [
        {
          ...
          senderId: user.id,
          senderType: 'company',
          message: '🎉 Chamada para entrevista! Parabéns! Gostaríamos de te chamar para uma entrevista.',
          timestamp: '2025-01-15T09:00:00Z'
        },
        {
          id: 2,
          senderId: selectedConversation.candidateId,
  ...
  return (
    <>
      <Helmet>
        <title>Mensagens - {user.companyName || 'Empresa'}</title>
        <meta name="description" content="Central de mensagens para comunicação com candidatos" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600">Comunique-se diretamente com os candidatos</p>
            </div>

            <div className="grid grid-cols-12 gap-6 h-[calc(100vh-200px)]">
              {/* Lista de conversas */}
              <div className="col-span-4">
                <Card className="h-full rounded-2xl border-0 shadow-lg bg-white">
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex items-center space-x-3 flex-1">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center justify-between">
                                  <h4 className="font-semibold text-gray-900 truncate">{conversation.candidateName}</h4>
                                  {conversation.unreadCount > 0 && (
                                ...
                                <p className="text-sm text-gray-500 truncate">{conversation.jobTitle}</p>
                                <p className="text-sm text-gray-600 truncate mt-1">{conversation.lastMessage}</p>
                                <p className="text-xs text-gray-400 mt-1">{formatDate(conversation.lastMessageTime)}</p>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="col-span-8">
                {selectedConversation ? (
                  <Card className="h-full rounded-2xl border-0 shadow-lg bg-white flex flex-col">
                    {/* Header do chat */}
                        ...
                        {messages.map((message) => (
                          ...
                          >
                            ...
                            >
                              <p className="text-sm">{message.message}</p>
                              <p className={`text-xs mt-1 ${
                                message.senderType === 'company' ? 'text-blue-100' : 'text-gray-500'
                              }`}>
                  ...
                  <Card className="h-full rounded-2xl border-0 shadow-lg bg-white flex items-center justify-center">
                    <div className="text-center">
                      <MessageSquare className="w-16 h-16 text-gray-300 mx-auto mb-4" />
                      <h3 className="text-xl font-semibold text-gray-600 mb-2">Selecione uma conversa</h3>
                      <p className="text-gray-500">Escolha um candidato para começar a conversar</p>
                    </div>
                  </Card>
                )}
              </div>
